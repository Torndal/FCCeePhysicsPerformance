...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               .Define("jetvertex", "JetVertexing::build_JetVertex(jetconstituents, RPrest, EFlowTrack_1)")
               .Define("jetsignificance", "JetVertexing::get_significance(jetvertex)")
               .Define("jetdistance",     "JetVertexing::get_distance(jetvertex)")
               .Define("jetsigma",        "JetVertexing::get_sigma_d(jetvertex)")
               .Define("jetchi2",         "JetVertexing::get_chi2(jetvertex)")
...
if __name__ == "__main__":
    ...
    if len(sys.argv)==1:
        ...
        sys.exit(3)
    infile = sys.argv[1]
    outDir = 'outputs/semileptonic/btag/'
    import os
